...
<div class="flex justify-between items-center mb-6">
    ...
    <div>
        ...
        <p class="text-gray-500 mt-1">
            Perbarui data order CleanGo Laundry.
        </p>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div>
                ...
                <input
                    type="text"
                    name="kode_order"
                    value="{{ old('kode_order', $order->kode_order) }}"
                    class="w-full border rounded-xl px-4 py-3 focus:ring-2 focus:ring-blue-500 focus:outline-none"
                    required>
            ...
            <div>
                ...
                <input
                    ...
                    value="{{ old('estimasi_selesai', $order->estimasi_selesai) }}"
                    class="w-full border rounded-xl px-4 py-3 focus:ring-2 focus:ring-blue-500 focus:outline-none"
                    required>
            ...
            <div>
                ...
                <select
                    ...
                    @foreach(['Antar','Jemput'] as $type)
                        ...
                        <option value="{{ $type }}" {{ $order->pickup_type == $type ? 'selected' : '' }}>
